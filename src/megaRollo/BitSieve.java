...
class BitSieve {
     ...
     * constructor, BitSieve(Matma base, int searchLen).  The length
     ...
     * be even.
     */
    BitSieve(Matma base, int searchLen) {
        /*
     ...
     */
    Matma retrieve(Matma initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    Matma candidate = initValue.add(
                            Matma.valueOf(offset));
